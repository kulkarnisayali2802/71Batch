    ...
    - generic [ref=f1e1]:
      ...
      - generic [ref=f1e6]:
        - generic [ref=f1e12]:
          ...
          - textbox "Code" [ref=f1e16]: "8839"
          - generic [ref=f1e17]: Last Name *
          - textbox "Last Name *" [active] [ref=f1e18]: Ameerpet
...
> 40 |         await frame.locator(this.textfield_Firstname).fill(this.firstname);
     |                                                       ^ Error: locator.fill: Error: strict mode violation: locator('#txtEmpFirstName') resolved to 2 elements:
  41 |         await frame.locator(this.textfiled_Middlename).fill(this.middlename);
  42 |         await frame.locator(this.textfield_Nickname).fill(this.nickname);
  43 | 
  44 |         await frame.locator(this.button_Save).click();
  45 |         console.log("clicked on save button, employee successfully created");
  46 | }
  47 | }
```